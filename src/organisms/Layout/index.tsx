...
export const LayOut: React.FC<Props> = ({ children }) => {
	...
	return (
		<div className="flex">
			<Sidebar />
			<div className="basis-[100%] text-white main bg-[#36454F] rounded-[8px] mx-[15px] my-[10px] px-[15px]">
				{location.pathname === "/" && (
					<>
						<div className="border border-[#fff] mt-[20px] rounded-[5px] p-5 text-base space-y-1">
							<h3 className="text-3xl">
								Welcome to <span className="text-[#42A7C3] font-semibold">Watchlist</span>
							</h3>
							<p>Browse movies, add them to watchlists</p>
							<p>
								Just click the <BsBookmarkPlusFill className={`text-3xl m-0 inline text-[rgb(245,197,24)]`} /> to add the movie, the
								poster to see more details to mark the movie as watched.
							</p>
						</div>
